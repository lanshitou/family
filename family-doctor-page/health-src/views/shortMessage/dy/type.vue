<template>
    <div class="layout-body">
        ...
        <Modal title="短语类型详情" v-model="modelcheck" ok-text='关闭' cancel-text=' ' @on-ok="handleSend" :mask-closable="false">
            <p>类型:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{code}}</p><br><br>
        </Modal>
        <Modal title="编辑短语类型" v-model="modeledit" ok-text='提交' :mask-closable="false">
