              ...
              <Row>
                ...
                <Col span="12">
                  <Form-item label="账号" prop="paccount">
                    <Input v-model="formData.paccount" placeholder="请输入电话号码作为登录账户" style="width: 250px"></Input>
                  </Form-item>
                </Col>
                <Col span="9" pull="2" >
                  <Form-item label="所属签约医疗机构" >
              ...
              <Row>
                <Col span="12">
                 <Form-item label="手机号码" prop="telephone">
                    <Input v-model="formData.telephone" placeholder="请输入手机号码" style="width: 250px"></Input>
                  </Form-item>
                </Col>
                <Col span="9" pull="2">
                  <Form-item label="执业医师证编号" prop="doctorscertificate">
                    <Input v-model="formData.doctorscertificate" placeholder="请输入编号" style="width: 250px"></Input>
                  </Form-item>
                </Col>
              </Row>
               <Row>
               ...
               <Row>
                <Col span="12">
                  <Row>
                    ...
                    <Col span="10" pull="2">
                    <Form-item label="性别" prop="sex" style="margin:0px">
                ...
                <Col span="9" pull="2">
                  <Form-item label="证件类型" prop="certificateidentity">
                    <Select v-model="formData.certificateidentity" style='width:250px' placeholder='请选择证件类型'  @on-change="changeC" :label-in-value="true">
               ...
               <Row>
                ...
                <Col span="9" pull="2">
                  <Form-item label="证件号码" prop="certificatenumber">
                    <Input v-model="formData.certificatenumber" placeholder="请输入证件号码" style="width: 250px"></Input>
                  </Form-item>
                </Col>
              </Row>
               <Row>
                <Col span="12">
                  <Form-item label="出生日期" prop="birthdate">
                    <Date-picker v-model="formData.birthdate" type="date" placeholder="请选择出生日期" style="width: 250px"></Date-picker>
                  </Form-item>
                </Col>
                <Col span="9" pull="2">
                  <Form-item label="职级类别" prop="professionallevelidentity">
                    <Select v-model="formData.professionallevelidentity" style='width:250px' placeholder='职级类别'  @on-change="changeD" :label-in-value="true">
               ...
               <Row>
                <Col span="12">
                  <Form-item label="邮箱" prop="email">
                    <Input v-model="formData.email" placeholder="请输入邮箱" style="width: 250px"></Input>
                  </Form-item>
                </Col>
                <Col span="9" pull="2">
                  <Form-item label="所在科室" prop="officesname">
                    <Select placeholder="请选择科室" @on-change="changeO" :label-in-value="true" style="width:250px">
...
<script>
import {
  insertDoctor, getOfficesPage, findDoctorLevel, findCertificateType, findCurrentOrg
} from '../../api/api'
export default {
  data () {
    ...
    return {
      ...
      ruleValidate: {
        ...
        telephone: [
          ...
          { type: 'string', max: 25, message: '手机号码不能超过50个字符', trigger: 'blur' },
          { validator: validateAccount, trigger: 'blur' }
        ],
        doctorname: [
  ...
  created: function () {
    ...
    findCurrentOrg().then((res) => {
      this.formData.institutionidentity = res.data.id
      this.formData.institutionname = res.data.orgname
    })
    // 获取所有医生职级类别
