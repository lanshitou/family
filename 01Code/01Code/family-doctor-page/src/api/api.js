...
// 根据条件查询全部签约医疗机构医生信息
export const getAllDocotr = params => { return axios.post(`${base}/doctor/findbycon`, params) }
// 分页查询签约医疗机构
...
// 查询全部医疗机构
export const getInstitutionAll = params => { return axios.get(`${base}/institution/findall`) }
// 条件医疗机构
export const getInstitution = params => { return axios.post(`${base}/institution/findbycon`, params) }
// 医生级别
...
// 条件查询医疗科室信息
export const getContactOffices = params => { return axios.post(`${base}/offices/findbycon`, params) }
// ID查询医疗科室信息
...
// 查询当前用户所属医疗机构及其下属的全部医疗机构
export const getInstitutionByUser = params => { return axios.get(`${base}/institution/findOriginAll`) }
// 查询全部科室信息
...
// 根据身份证号查询预约服务信息POST /contact/findAppointmentByCon
...
// 审批居民签约协议数据(更改协议和服务状态并且生成服务计划 POST /contact/approval{id}
...
//  查询当前机构转诊服务对照关系信息GET /contrast/findCruuentOrgContrast
