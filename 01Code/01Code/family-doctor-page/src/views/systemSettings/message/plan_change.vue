<template>
  <div class="index">
    <Table :data="listData" :columns="tableColumns" stripe border></Table>
...
export default {
            ...
            return h('div', [
              ...
              h('Tooltip', {
                ...
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.$router.push({ name: 'referral/add', params: {identitynumber: params.row.identitynumber} })
                    }
                  }
                }),
                h('div', {
  ...
  created: function () {
    this.searchInfos.id = this.$route.params.id
    let para = {
      page: 1,
      rows: this.rows,
